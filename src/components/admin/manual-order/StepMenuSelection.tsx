                ...
                {groupedItems.map(({ groupName, groupItems }) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <ChevronDown
                        className={`h-5 w-5 text-muted-foreground transition-transform duration-200 ${expandedGroups.has(groupName) ? "rotate-180" : ""}`}
                      />
                    </button>
                    ...
                    {expandedGroups.has(groupName) && (
                      <div className="divide-y divide-border/50 border-t border-border/50 bg-background/50">
                        {groupItems.map((item) => {
                          ...
                          // Fix logic error on max portions check for menu list
                          const reachedMax =
                                  ...
                                  <div>
                                    ...
                                    {!isOutOfStock &&
                                      item.max_portions !== null && (
                                        <span
                                          className={`mt-1 inline-block text-[10px] px-1.5 py-0.5 rounded border ${item.max_portions! < 5 ? "bg-amber-50 text-amber-700 border-amber-200" : "bg-green-50 text-green-700 border-green-200"}`}
                                        >
