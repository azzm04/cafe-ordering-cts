    ...
    <main className="min-h-screen bg-background p-4 sm:p-6 lg:p-8">
      ...
      <div className="max-w-2xl mx-auto relative z-10">
          ...
          {isCompleted ? (
            <>
              ...
              <p className="text-base sm:text-lg text-muted-foreground">
                Terima kasih telah memesan di Coklat Tepi Sawah. Sampai jumpa lagi!
              </p>
            </>
          ) : isFailed ? (
            <>
            ...
            <>
              ...
              {/* Auto refresh for tracking fulfillment */}
              <NotaAutoRefresh
            ...
            <>
              ...
              {/* Auto refresh for tracking payment */}
              <NotaAutoRefresh
                orderNumber={order.order_number}
                initialPaymentStatus={order.payment_status}
                initialFulfillmentStatus={order.fulfillment_status}
        ...
        <Card className="p-6 sm:p-8 space-y-6 border border-border shadow-sm">
          {/* Fulfillment Timeline - Only show if paid */}
          {isPaid && (
            <div className="mb-6">
              <FulfillmentTimeline currentStatus={order.fulfillment_status} />
            </div>
          )}
        ...
        {/* Share actions only for paid orders */}
